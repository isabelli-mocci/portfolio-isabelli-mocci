...
export const ANIMATION_TIMING = {
  INTERVAL_DURATION: ANIMATION_DEFAULTS.INTERVAL_DURATION,
  TRANSITION_DURATION: ANIMATION_DEFAULTS.TRANSITION_DURATION,
  FADE_OUT_DURATION: ANIMATION_DEFAULTS.TRANSITION_DURATION / 2,
} as const;
