export const SKILLS_SECTION_CONFIG = {
  ...
  styles: {
    ...
    title: 'text-center text-3xl sm:text-4xl md:text-5xl lg:text-5xl mb-4 tracking-tight flex items-center gap-2 bg-gradient-to-r from-primary-color via-primary-color to-green-300 bg-clip-text text-transparent font-medium',
    subtitle: 'text-white/80 text-center font-medium md:text-lg mb-20 max-w-xl mx-auto',
