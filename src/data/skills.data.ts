...
export const createSkillsData = (): readonly SkillData[] => [
  ...
  { name: 'JavaScript', icon: React.createElement(JavaScript), category: 'language', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
  { name: 'Tailwind CSS', icon: React.createElement(TailwindCSS), category: 'styling', url: 'https://tailwindcss.com/' },
  { name: 'Express', icon: React.createElement(Express), category: 'backend', url: 'https://expressjs.com/' },
  ...
  { name: 'HTML', icon: React.createElement(HTML5), category: 'language', url: 'https://developer.mozilla.org/en-US/docs/Web/HTML' },
  { name: 'CSS', icon: React.createElement(CSS), category: 'styling', url: 'https://developer.mozilla.org/en-US/docs/Web/CSS' },
] as const;
